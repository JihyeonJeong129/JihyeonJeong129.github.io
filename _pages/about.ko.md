...
대규모 트래픽을 다룬 경험은 아니지만, 개인 홈랩 수준에서도 운영의 결과를 지표로 남기려 합니다. 스토리지 노드는 마지막 점검 이후 약 **255일**째 무중단으로 동작하고, 5년 넘게 가동한 디스크도 아직 SMART 상 이상이 없으며, 연산 노드는 실제 정전을 UPS로 버티며 약 **254일**째 재부팅 없이 운영되고 있습니다. (26.06.15 기준)
